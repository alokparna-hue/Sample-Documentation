...
**User query:** The primary goal was to generate a summary of the book and get a clear demarcation between primary and secondary humans, with each characters divided between 'primary' and 'secondary'.
